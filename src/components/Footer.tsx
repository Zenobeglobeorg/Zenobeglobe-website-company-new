    ...
    <footer className="w-full bg-[#1a1a1a] text-white overflow-hidden">
      <div className="container mx-auto px-4 lg:px-8 py-12 lg:py-16">
        ...
        >
          <motion.div variants={fadeInUp}>
            ...
            <div className="flex gap-3">
              <motion.a
                ...
                className="w-10 h-10 rounded-full bg-white flex items-center justify-center hover:bg-[hsl(var(--brand-cyan))] transition-colors"
            ...
            <ul className="space-y-2">
              <motion.li whileHover={{ x: 5 }}>
                <Link
                  ...
                  className="text-gray-400 hover:text-white transition-colors"
                >
                  Securite et Reseau Informatique
                </Link>
              </motion.li>
              <motion.li whileHover={{ x: 5 }}>
                <Link
          ...
          <motion.div variants={fadeInUp}>
            <h3 className="font-poppins font-semibold text-lg mb-4">CONTACTEZ-NOUS</h3>
            <motion.a 
              href="https://wa.link/eyvnes"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-400 mb-2 block hover:text-white transition-colors cursor-pointer"
              whileHover={{ x: 5 }}
            >
        ...
        >
          <p>
            © {new Date().getFullYear()} ZenobeGlobe. Tous droits réservés.
          </p>
        </motion.div>
      </div>
    </footer>
